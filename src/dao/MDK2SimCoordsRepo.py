...
class MDK2SimCoordsRepo:
    ...
    """
    Returns all coordinate-related parameters from the 'medslik2.sim_coords' configuration section
    """
    def get_all_params(self):
        return self.config_instance.get_config_value('medslik2.sim_coords')