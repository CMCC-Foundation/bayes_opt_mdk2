...
class MDK2SimExtentRepo:
    ...
    """
    Returns all coordinate-related parameters from the 'medslik2.sim_extent' configuration section
    """
    def get_all_params(self):
        return self.config_instance.get_config_value('medslik2.sim_extent')