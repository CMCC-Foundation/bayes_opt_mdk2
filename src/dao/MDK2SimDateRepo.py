...
class MDK2SimDateRepo:
    ...
    """
    Returns all coordinate-related parameters from the 'medslik2.sim_date' configuration section
    """
    def get_all_params(self):
        return self.config_instance.get_config_value('medslik2.sim_date')